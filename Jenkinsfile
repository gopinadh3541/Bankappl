node('master') {
    ...
    stage('Deploy')
   {
      ...
      bat 'mv C:\\jenkins_installpath\\workspace\\BankAppl\\target\\BankExample-1.war C:\\Oracle\\Middleware\\Oracle_Home\\user_projects\\domains\\domain1\\autodeploy\\BankExample-1.war'
